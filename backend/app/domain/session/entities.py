...
class SessionState:
    ...
    user_id: str | None = None          # None for anonymous kiosk sessions; populated upon WhatsApp/Web login
    user_profile: dict[str, Any] | None = None  # Optional enriched customer taste profile
    metadata: dict[str, Any] = field(default_factory=dict)
